...
- **type**: the type of box this should be. Valid values are `important`, `danger`, `info`, `plain` and `warning` (see [sample_types.md](https://github.com/hayribakici/box/blob/main/sample_types.pdf)). 
